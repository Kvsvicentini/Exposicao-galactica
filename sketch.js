...
function setup() {
  ...
  // Aqui você pode inserir mais músicas seguindo o mesmo padrão!
  playlistGG = [
  ...
  // Configura todas as músicas da fita para rodarem em loop caso cheguem ao fim
  for (let musica of playlistGG) {
    musica.audio.loop = true;
  }
